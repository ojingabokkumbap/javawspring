...
<head>
  ...
  <script>
    'use strict';
    // 아이디와 닉네임 중복버튼을 클릭했는지를 확인하기위한 전역변수를 정의한다.(버튼클릭 후에도 내용을 수정했다면 초기값은 0으로 셋팅해서 버튼을 누를수 있도록해야한다.)
    let idCheckSw = 0;
  	let nickCheckSw = 0;
    ...
    function idCheck() {
    	...
    	if(mid.trim() == "" || mid.length < 4 || mid.length > 20 ) {
    		alert("아이디를 입력하세요!(아이디는 4~20자 이내로 입력해야 합니다.)");
    		myform.mid.focus();
    		return false;
    	}
...
<p><br/></p>
<jsp:include page="/WEB-INF/views/include/footer.jsp"></jsp:include></body>
</html>